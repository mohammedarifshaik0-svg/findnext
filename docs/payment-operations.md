...
2. If Resend is configured, the user immediately receives the branded request-received email. Support replies with the payment instructions and exact amount. Do not publish a personal UPI ID in the app or repository.
