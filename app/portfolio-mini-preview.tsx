...
type PreviewData = {
  ...
  items: Array<{ id: string; itemType: string; title: string }>;
};
...
export function PortfolioMiniPreview({ data, activeSection = "profile" }: { data: PreviewData; activeSection?: string }) {
  ...
  return (
    <div className="relative min-h-[1150px] overflow-hidden bg-[var(--portfolio-bg)] p-7 text-[var(--portfolio-text)] [font-family:Georgia,serif]" style={focusStyle}>
      <div
        className="pointer-events-none absolute inset-0"
        style={{
