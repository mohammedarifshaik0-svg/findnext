  ...
  return <main className={`vxl-workspace ${uiTheme === "dark" ? "is-dark" : "is-light"}`}>
    ...
    <div className="vxl-studio-grid">
      ...
      <section className="min-w-0 space-y-5">
        ...
        {activeTab === "profile" && savedAt && <AiWriting headline={data.headline} summary={data.professionalSummary} onApply={(field, value) => update(field === "headline" ? "headline" : "professionalSummary", value)} />}
