...
type Payload = { fullName?: string; headline?: string; professionalSummary?: string; email?: string; phone?: string; city?: string; country?: string; pronouns?: string; portfolioSlug?: string; theme?: string; accent?: string; effectIntensity?: number; isPublic?: boolean; consentProfileStorage?: boolean; consentTalentDiscovery?: boolean; experiences?: Experience[]; education?: Education[]; items?: Item[] };
